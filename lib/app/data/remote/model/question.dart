...
QuestionByIdModel questionByIdModelFromJson(String str) =>
    QuestionByIdModel.fromJson(json.decode(str));

String questionByIdModelToJson(QuestionByIdModel data) =>
...
class QuestionByIdModel {
  ...
  factory QuestionByIdModel.fromJson(Map<String, dynamic> json) =>
      QuestionByIdModel(
